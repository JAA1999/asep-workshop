...
class GameForm(forms.ModelForm):
    ...
    class Meta:
        model = Game
        fields = ("name", "age_rating", "description",
                  "release_date", "category", "picture", "file_name")
...
class UserForm(forms.ModelForm):
    # ,max_length = 32, help_text="Create a password of at least 8 characters long ",required=True)
...
class CommentForm(forms.ModelForm):
    ...
    content = forms.CharField(label="", widget=forms.Textarea(
        attrs={'class': 'form-control', 'placeholder': 'Add a public comment here', 'rows': '4', 'cols': '50'}))
